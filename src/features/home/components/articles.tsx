...
const Articles: React.FC<articlesProp> = ({ title, body, Img }) => {
  return (
    <div className="px-5 md:px-3 h-fit flex flex-col">
      <div className="border-b-[1px] flex gap-4 md:gap-8 items-center border-dotted border-slate-300 shadow-gray-300 h-44 text-sm">
        ...
        <div className="h-32 md:h-28 md:w-44 w-36 mr-10">
